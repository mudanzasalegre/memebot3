...
class _Config:
    ...
    RESEARCH_RANK_CANARY_MIN_PRICE5M: float = _num_env("RESEARCH_RANK_CANARY_MIN_PRICE5M", float, 25.0)
    ...
    LATE_MOMENTUM_WATCH_AUTORESEARCH_ENABLED: bool = _bool_env("LATE_MOMENTUM_WATCH_AUTORESEARCH_ENABLED", True)
    ...
    SNIPER_RESEARCH_HIGH_ACTIVITY_ENABLED: bool = _bool_env("SNIPER_RESEARCH_HIGH_ACTIVITY_ENABLED", True)
    SNIPER_RESEARCH_HIGH_ACTIVITY_MIN_TXNS_5M: int = _num_env(
        "SNIPER_RESEARCH_HIGH_ACTIVITY_MIN_TXNS_5M",
        int,
        500,
    )
    SNIPER_RESEARCH_HIGH_ACTIVITY_REQUIRE_ROUTE: bool = _bool_env(
        "SNIPER_RESEARCH_HIGH_ACTIVITY_REQUIRE_ROUTE",
        True,
    )
    ...
    RUNNER_FLOOR_PEAK_100: float = _num_env("RUNNER_FLOOR_PEAK_100", float, 50.0)
    RUNNER_FLOOR_PEAK_300: float = _num_env("RUNNER_FLOOR_PEAK_300", float, 150.0)
    RUNNER_FLOOR_PEAK_700: float = _num_env("RUNNER_FLOOR_PEAK_700", float, 350.0)
    RUNNER_FLOOR_PEAK_1000: float = _num_env("RUNNER_FLOOR_PEAK_1000", float, 500.0)
    RUNNER_FLOOR_PEAK_2000: float = _num_env("RUNNER_FLOOR_PEAK_2000", float, 800.0)
...
SNIPER_RESEARCH_HIGH_ACTIVITY_ENABLED = CFG.SNIPER_RESEARCH_HIGH_ACTIVITY_ENABLED
SNIPER_RESEARCH_HIGH_ACTIVITY_MIN_TXNS_5M = CFG.SNIPER_RESEARCH_HIGH_ACTIVITY_MIN_TXNS_5M
SNIPER_RESEARCH_HIGH_ACTIVITY_REQUIRE_ROUTE = CFG.SNIPER_RESEARCH_HIGH_ACTIVITY_REQUIRE_ROUTE
