...
class _Config:
    ...
    RESEARCH_RANK_CANARY_MAX_SIZE_SOL: float = _num_env("RESEARCH_RANK_CANARY_MAX_SIZE_SOL", float, 0.02)
    ...
    MOONSHOT_MICRO_LOTTERY_MAX_DAILY_BUYS: int = _num_env("MOONSHOT_MICRO_LOTTERY_MAX_DAILY_BUYS", int, 9)
