...
class _Config:
    ...
    RESEARCH_RANK_CANARY_MIN_SCORE: float = _num_env("RESEARCH_RANK_CANARY_MIN_SCORE", float, 61.15)
    ...
    LATE_MOMENTUM_WATCH_MIN_LIQUIDITY_USD: float = _num_env("LATE_MOMENTUM_WATCH_MIN_LIQUIDITY_USD", float, 5000.0)
