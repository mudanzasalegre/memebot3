...
class _Config:
    ...
    ML_TRAIN_ENTRY_LANE_ALLOWLIST: str = os.getenv(
        ...
        "pump_early_pumpswap_profit,pump_early_pumpswap_prime,pump_early_meteor_prime,pump_early_pumpswap_breakout_probe,pump_early_green_candle_sniper",
    )
    ...
    ML_BOOTSTRAP_ENTRY_LANE_ALLOWLIST: str = os.getenv(
        ...
        "pump_early_pumpswap_profit,pump_early_pumpswap_prime,pump_early_meteor_prime,pump_early_pumpswap_breakout_probe,pump_early_green_candle_sniper,pump_early_sniper_research",
    )
    ...
    HOT_QUEUE_MAX_SIZE: int = _num_env("HOT_QUEUE_MAX_SIZE", int, 300)
    HOT_QUEUE_BATCH_SIZE: int = _num_env("HOT_QUEUE_BATCH_SIZE", int, 12)
    ...
    GREEN_SNIPER_LIVE_SIZE_SOL: float = _num_env("GREEN_SNIPER_LIVE_SIZE_SOL", float, 0.10)
    ...
    GREEN_SNIPER_LIVE_MAX_DAILY_LOSS_SOL: float = _num_env("GREEN_SNIPER_LIVE_MAX_DAILY_LOSS_SOL", float, 0.30)
