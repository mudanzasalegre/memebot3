...
class _Config:
    ...
    ML_TRAIN_ENTRY_LANE_ALLOWLIST: str = os.getenv(
        ...
        "pump_early_pumpswap_profit,pump_early_pumpswap_prime,pump_early_meteor_prime,pump_early_pumpswap_breakout_probe",
    )
    ...
    ML_BOOTSTRAP_ENTRY_LANE_ALLOWLIST: str = os.getenv(
        ...
        "pump_early_pumpswap_profit,pump_early_pumpswap_prime,pump_early_meteor_prime,pump_early_pumpswap_breakout_probe,pump_early_sniper_research",
    )
