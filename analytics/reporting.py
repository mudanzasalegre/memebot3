...
_CONFIG_KEYS = [
    ...
    "GREEN_SNIPER_RESTRICTED_MIN_RANK",
    "GREEN_SNIPER_RESTRICTED_MIN_TXNS",
    "GREEN_SNIPER_RESTRICTED_MIN_LIQUIDITY",
    "GREEN_SNIPER_RESTRICTED_MIN_MCAP",
    "GREEN_SNIPER_RESTRICTED_MAX_MCAP",
    "GREEN_SNIPER_RESTRICTED_MIN_PRICE5M",
    "GREEN_SNIPER_RESTRICTED_MAX_PRICE5M",
    "GREEN_SNIPER_RESTRICTED_REQUIRE_ROUTE",
    ...
    "RESEARCH_RANK_CANARY_MIN_TXNS_5M",
    "RESEARCH_RANK_CANARY_MIN_MCAP_USD",
    "RESEARCH_RANK_CANARY_MAX_MCAP_USD",
    "RESEARCH_RANK_CANARY_MIN_PRICE5M",
    "RESEARCH_RANK_CANARY_MAX_PRICE5M",
    ...
    "POST_PARTIAL_LOCK_FLOOR_ENABLED",
    "POST_PARTIAL_LOCK_FLOOR_PCT",
    "POST_PARTIAL_MAX_GIVEBACK_PCT",
    "POST_PARTIAL_MIN_PEAK_PCT",
