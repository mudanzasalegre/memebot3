...
def _common_payload(
    ...
    *,
    ...
    out = {
        ...
        "entry_subprofile": token.get("entry_subprofile") or token.get("sniper_research_subprofile"),
        "sniper_research_subprofile": token.get("sniper_research_subprofile") or token.get("entry_subprofile"),
        "sniper_research_subprofile_reason": token.get("sniper_research_subprofile_reason"),
        "sniper_research_subprofile_failures": token.get("sniper_research_subprofile_failures"),
