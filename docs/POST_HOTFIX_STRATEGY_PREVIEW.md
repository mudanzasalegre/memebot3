...
- Baseline closed rows: `0`
- Expected total PnL delta: `1926.4630` pct-points
- Expected severe loss delta: `0`
- Expected runner capture delta: `0.001300`
...
- Post-partial expected total delta: `1926.4630`
